...
def createBlocks(base, obj, extrusion_vector, base_wires):
    ...
    This function generates a wall or slab composed of individual blocks by
    extruding and cutting the base shape according to the specified block
    dimensions, offsets, and joints.
